...
generalized one-vertex \(3\)-manifold triangulations, keeps the vertex count
equal to one, grades complexity by the number of tetrahedra, and permits
\(2\)--\(0\) moves.  Here the triangulations are simplicial, the horizontal
slices fix an arbitrary vertex count, and the grading itself is by vertex
number.  The two normal-form statements concern different categories and
